...
3. 学习 Git 基础后，再看 Git 暂存区和自动检查：[[Index的常见含义#四、Git Index：暂存区|Git Index]]、[[Git Hook与自动化检查]]；准备把软件交付给用户时，先分清 [[开发、测试、预发布与生产环境]]，再学习 [[软件供应链：代码签名、SBOM与发布门禁]] 和 [[金丝雀发布、灰度发布与渐进式交付]]。
