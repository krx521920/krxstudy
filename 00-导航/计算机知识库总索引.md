...
5. 再理解域名怎样找到服务器、网络怎样传输网页、TLS 怎样保护连接，以及代理如何改变流量路径：[[DNS域名系统]]、[[TCP、HTTP、HTTPS与WebSocket]]、[[TLS与数字证书]]、[[系统代理、VPN与端口]]。
6. 然后理解网页、界面和前端构建：[[HTML]]、[[CSS]]、[[渲染逻辑]]、[[Toast提示]]、[[../02-Web前端与界面/WebView]] 和 [[Webpack与HMR]]。
...
10. 用实际产品案例串联前面的知识：先看 [[Otto与Otto USB对比及重点摘要]]，再分别学习 [[Otto产品总体技术架构]] 和 [[Otto USB便携智能体]]。
