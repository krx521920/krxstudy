...
2. 再理解网页与界面：[[CSS]]、[[渲染逻辑]]、[[Toast提示]]。
3. 学习 Python 和数据库基础后，再看 [[Django]] 与 [[ORM]]。
4. 理解大语言模型的基本使用后，再看 [[LangChain]]、[[Prompt Engineering与Loop Engineering]] 和 [[RAG、Naive RAG与GraphRAG]]。
5. 最后学习 Agent 工程：[[DeepSeek Harness、Everything is a Plugin与Cordis]]。
