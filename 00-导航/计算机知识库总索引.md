...
8. 理解大语言模型的基本使用后，先通过 [[Transformer与注意力机制]] 认识 Token、Embedding、自注意力、QKV、Encoder/Decoder 和 GPT 的生成过程，再学习 [[RLHF与大模型对齐]] 怎样用 SFT、人类偏好、奖励模型、PPO 或 DPO 调整模型行为；然后区分 [[知识库是什么：个人、团队与AI知识库|个人、团队与 AI 知识库]]，继续学习 [[LangChain]]、[[Prompt Engineering与Loop Engineering]]、[[RAG、Naive RAG与GraphRAG]] 和 [[LLM Wiki]]。
