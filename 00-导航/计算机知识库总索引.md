...
2. 再理解进程与线程，然后认识常见编程语言、Java 高并发、位置与查找含义、程序状态与重复操作，以及 JavaScript 工具链：[[进程、线程、多进程与多线程]]、[[常见编程语言及其用途]]、[[Java为什么适合高并发]]、[[Index的常见含义]]、[[状态机与幂等性]]、[[TypeScript与JavaScript]]、[[Node.js与pnpm]]。
